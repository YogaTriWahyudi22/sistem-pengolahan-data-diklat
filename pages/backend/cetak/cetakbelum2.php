...
<body>
    <?php 
        $pejabat = $conn->query("SELECT * FROM tb_pejabat WHERE status ='Belum Diklat' AND ket LIKE 'II__' ");
        $total = mysqli_num_rows($pejabat);
    ?>

    <h2 style="text-align: center;" class="text-gray-900">Laporan Data Pejabat yang Belum Mengikuti Pelatihan Kepemimpinan Tingkat II</h2>
