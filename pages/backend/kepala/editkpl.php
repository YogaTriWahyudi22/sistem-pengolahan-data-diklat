...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-900">Form Ubah Data Kepala Sub Bidang</h1>

<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-info">Ubah Data Kepala Sub Bidang</h6>
  </div>
  <div class="card-body">
        ...
        <div class="form-group">
            <label>Level</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tlevel" id="flexRadioDefault1" value="admin">
                    <label class="form-check-label" for="flexRadioDefault1">
                        admin
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tlevel" id="flexRadioDefault2" value="kepalabidang" checked>
  ...
  $update = $conn->query("UPDATE tb_user SET 
    ...
    if ( $update ) {
            ...
            echo "<script>
                      ...
                      window.location = 'index.php?page=kepala/editkpl&id=". $username." '
                  </script>";
