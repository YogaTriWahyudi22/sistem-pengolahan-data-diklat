...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-900">Form Tambah Data Kepala Sub Bidang</h1>

<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-info">Tambah Data Kepala Sub Bidang</h6>
  </div>
  <div class="card-body">
  ...
  $tambah = $conn->query("INSERT INTO tb_user ( 
    ...
    if ( $tambah ) {
        echo "<script>
                ...
                window.location.href = 'index.php?page=kepala/viewkpl'
              </script>";
    } else {
        echo "<script>
